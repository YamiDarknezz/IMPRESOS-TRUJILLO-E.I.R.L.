...
| HU-05 | Como Operario de Taller, quiero visualizar y gestionar las órdenes de trabajo en un tablero visual Kanban por etapas de manufactura para reportar el progreso operativo en tiempo real. | 5 SP | Must Have (5) |
...
A continuación, se detalla la formulación formal de las Historias de Usuario, acompañada de sus Criterios de Aceptación bajo el estándar Gherkin (Dado que / Cuando / Entonces), su valor de negocio para la empresa y las representaciones visuales (wireframes/mockups de interfaz) diseñadas para la arquitectura web en Angular 21, conforme a las directivas del curso:
...
Historias de Usuario (HU-05, HU-06): Como Operario de Taller, quiero gestionar las órdenes de trabajo mediante un tablero visual Kanban de 4 etapas (Diseño, Impresión, Acabados, Listo) y reportar las mermas reales post-impresión para mantener la visibilidad del estado de cada pedido y sincronizar los inventarios.
•   Criterio de Aceptación 1 (Transición de Estados de Taller): Dado que un diseñador concluye la diagramación y el cliente aprueba el arte digital, el operario arrastra la tarjeta de la OT a la columna «En Impresión», actualizando el estado inmediatamente en la base de datos y notificando al área de plotter.
...
Figura 3. Wireframe de Interfaz: Tablero Visual de Producción y Control de Taller (Kanban)
...
Figura 5. Wireframe de Interfaz: Dashboard Gerencial BI y Modelo Predictivo de Insumos IA
